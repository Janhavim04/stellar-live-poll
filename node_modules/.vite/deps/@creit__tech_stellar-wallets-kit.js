...
var i2 = class {
  ...
  async signTransaction(t8, s6) {
    return this.selectedModule.signTransaction(t8, { ...s6, networkPassphrase: s6?.networkPassphrase || a.getValue().selectedNetwork });
  }
  async signAuthEntry(t8, s6) {
    return this.selectedModule.signAuthEntry(t8, { ...s6, networkPassphrase: s6?.networkPassphrase || a.getValue().selectedNetwork });
  }
  async signMessage(t8, s6) {
    return this.selectedModule.signMessage(t8, { ...s6, networkPassphrase: s6?.networkPassphrase || a.getValue().selectedNetwork });
  }
  async getNetwork() {
  ...
  async removeButton(e6) {
    ...
    true !== e6?.skipDisconnect && this.buttonElement.disconnect(), this.buttonElement.remove(), delete this.buttonElement;
  }
  async openModal(e6) {
...
var ReactiveElement = class extends HTMLElement {
  ...
  __initialize() {
    ...
    this.requestUpdate();
    this.constructor._initializers?.forEach((i4) => i4(this));
  }
  /**
  ...
  connectedCallback() {
    ...
    this.__controllers?.forEach((c4) => c4.hostConnected?.());
  }
  /**
  ...
  disconnectedCallback() {
    this.__controllers?.forEach((c4) => c4.hostDisconnected?.());
  }
  /**
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        this.__controllers?.forEach((c4) => c4.hostUpdate?.());
  ...
  _$didUpdate(changedProperties) {
    this.__controllers?.forEach((c4) => c4.hostUpdated?.());
    if (!this.hasUpdated) {
  ...
  update(_changedProperties) {
    this.__reflectingProperties &&= this.__reflectingProperties.forEach((p2) => this.__propertyToAttribute(p2, this[p2]));
    this.__markUpdated();
  }
  /**
...
var isIterable2 = (value) => isArray(value) || // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  _$setValue(value, directiveParent = this, valueIndex, noCommit) {
    ...
    if (strings === void 0) {
      ...
      for (i4 = 0; i4 < strings.length - 1; i4++) {
        ...
        change ||= !isPrimitive(v2) || v2 !== this._$committedValue[i4];
        if (v2 === nothing) {
          value = nothing;
  ...
  if (kind === "accessor") {
    ...
    return {
      set(v2) {
        ...
        this.requestUpdate(name, oldValue, options, true, v2);
      },
      init(v2) {
        if (v2 !== void 0) {
...
var f3 = class extends LitElement {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this.fetchAddressSubscription?.unsubscribe();
  }
  render() {
    const t8 = html`
...
var n = class {
  ...
  async signTransaction(e6, r9) {
    return src_default.tx({ xdr: e6, pubkey: r9?.address, network: r9?.networkPassphrase ? r9.networkPassphrase === e.PUBLIC ? "public" : "testnet" : void 0 }).then((({ signed_envelope_xdr: t8 }) => ({ signedTxXdr: t8, signerAddress: r9?.address }))).catch(((t8) => {
      throw d3(t8);
    }));
  }
  async signAuthEntry() {
...
var c2 = class {
  ...
  async signTransaction(r9, s6) {
    return this.runChecks().then((async () => {
      const { signedTxXdr: t8, signerAddress: n8, error: a5 } = await (0, import_freighter_api.signTransaction)(r9, { address: s6?.address, networkPassphrase: s6?.networkPassphrase });
      if (a5) throw a5;
  ...
  async signAuthEntry(r9, s6) {
    return this.runChecks().then((async () => {
      const { signedAuthEntry: e6, signerAddress: n8, error: a5 } = await (0, import_freighter_api.signAuthEntry)(r9, { address: s6?.address, networkPassphrase: s6?.networkPassphrase });
      if (a5 || !e6) throw a5;
  ...
  async signMessage(r9, s6) {
    return this.runChecks().then((async () => {
      const { signedMessage: e6, signerAddress: t8, error: a5 } = await (0, import_freighter_api.signMessage)(r9, { address: s6?.address, networkPassphrase: s6?.networkPassphrase });
      if (a5 || !e6) throw a5;
...
var c3 = class {
  ...
  async signTransaction(s6, e6) {
    return (async () => {
      if (!await (0, import_signer_extension_api.isConnected)()) throw new Error("Lobstr is not connected");
      e6?.address && console.warn("Lobstr doesn't allow specifying what public key should sign the transaction, we skip the value"), e6?.networkPassphrase && console.warn("Lobstr doesn't allow specifying the network that should be used, we skip the value");
...
var r6 = class {
  ...
  async signTransaction(t8, n8) {
    return (async () => {
      if (!window.rabet) throw new Error("Rabet is not installed");
      if (n8?.address && n8.networkPassphrase !== e.PUBLIC && n8.networkPassphrase !== e.TESTNET) throw new Error(`Rabet doesn't support the network: ${n8.networkPassphrase}`);
      n8?.address && console.warn("Rabet doesn't allow specifying the network that should be used, we skip the value");
    })().then((async () => window.rabet.sign(t8, n8?.networkPassphrase === e.PUBLIC ? "mainnet" : "testnet"))).then(((t9) => ({ signedTxXdr: t9?.xdr }))).catch(((t9) => {
      throw d3(t9);
    }));
  }
  async signAuthEntry() {
...
var r7 = class {
  ...
  async enableConnection() {
    ...
    if (!t8 || t8.error) throw { code: t8?.code || -1, message: t8?.errorMessage || "Unexpected error" };
  ...
  async getAddress() {
    try {
      ...
      return { error: { code: e6?.code || -1, message: e6?.message || "Unexpected error" } };
    }
    ...
    return !t8 || t8.error ? { error: { code: t8?.code || -1, message: t8?.errorMessage || "Unexpected error" } } : { address: t8.payload };
  }
  async signTransaction(r9) {
    if (r9.opts?.submit || r9.opts?.submitUrl) return { error: { code: -1, message: "Parameters `submit` and `submitUrl` are not supported" } };
    try {
      await this.enableConnection();
    } catch (e6) {
      return { error: { code: e6?.code || -1, message: e6?.message || "Unexpected error" } };
    }
    const o5 = { origin: window.origin, host: window.location.host, network: r9.opts?.networkPassphrase, publicKey: r9.opts?.address, xdr: r9.xdr, xdrType: "Transaction" }, t8 = await this.sendEventToContentScript(L2.XBULL_SIGN_XDR, o5, crypto.randomUUID()), { detail: n8 } = t8.data;
    return !n8 || n8.error ? { error: { code: n8?.code || -1, message: n8?.errorMessage || "Unexpected error" } } : { signedTxXdr: n8.payload.signedXdr, signerAddress: n8.payload.signerAddress };
  }
  async getNetwork() {
    try {
      await this.enableConnection();
    ...
    return !t8 || t8.error ? { error: { code: t8?.code || -1, message: t8?.errorMessage || "Unexpected error" } } : { network: t8.payload.network, networkPassphrase: t8.payload.networkPassphrase };
  }
};
...
var w3 = class {
  constructor(o5) {
    ...
    })), this.preferredTarget = o5?.preferredTarget || "extension", this.walletUrl = o5?.url || "https://wallet.xbull.app/connect";
  ...
  async connect(e6 = { canRequestPublicKey: true, canRequestSign: true }) {
    const s6 = window?.webkit?.messageHandlers?.cordova_iab ? new r7() : window.xBullSDK;
...
var n6 = class {
  ...
  async signTransaction(s6, o5) {
    try {
      const e6 = new w3(), n8 = await e6.sign({ xdr: s6, publicKey: o5?.address, network: o5?.networkPassphrase });
      return e6.closeConnections(), { signedTxXdr: n8, signerAddress: o5?.address };
    } catch (t8) {
      throw d3(t8);
    }
  }
...
var n7 = class {
  ...
  async getAddress() {
    return (async () => {
      if (!window.hanaWallet?.stellar) throw new Error("Hana Wallet is not installed");
  ...
  async signTransaction(t8, s6) {
    return (async () => {
      if (!window.hanaWallet?.stellar) throw new Error("Hana Wallet is not installed");
    })().then((async () => window.hanaWallet.stellar.signTransaction({ xdr: t8, accountToSign: s6?.address, networkPassphrase: s6?.networkPassphrase }))).then(((t9) => ({ signedTxXdr: t9, signerAddress: s6?.address }))).catch(((t9) => {
      throw d3(t9);
    }));
  }
  async signAuthEntry(t8, s6) {
    return (async () => {
      if (!window.hanaWallet?.stellar) throw new Error("Hana Wallet is not installed");
    })().then((async () => window.hanaWallet.stellar.signAuthEntry({ xdr: t8, accountToSign: s6?.address }))).then(((t9) => ({ signedAuthEntry: t9, signerAddress: s6?.address }))).catch(((t9) => {
      throw d3(t9);
    }));
  }
  async signMessage() {
...
function d3(e6) {
  return { code: e6?.error?.code || e6?.code || -1, message: e6?.error?.message || e6?.message || "string" == typeof e6 && e6 || "Unhandled error from the wallet", ext: e6?.error?.ext || e6?.ext };
}
export {
  r4 as ALBEDO_ID,
  n as AlbedoModule,
